...
This script performs project-specific data engineering approved as a narrow
exception to the textbook-only econometric-code restriction. It has no network
access, never changes the source files, and writes only predetermined files
